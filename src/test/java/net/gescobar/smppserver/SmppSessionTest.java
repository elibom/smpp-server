...
public class SmppSessionTest {
	...
	private void shouldCreateSessionHelper(int bindType) throws Exception {
		...
		Assert.assertEquals(bindResponse.getCommandStatus(), ResponseStatus.OK.getCommandStatus());
	...
	public void shouldCallCustomPacketProcessor() throws Exception {
		...
		smppSession.setPacketProcessor(new PacketProcessor() {
			...
			public ResponseStatus processPacket(SMPPPacket packet) {
				return ResponseStatus.BIND_FAILED;
			}
		...
		Assert.assertNotNull(bindResponse);
		Assert.assertEquals(bindResponse.getCommandStatus(), ResponseStatus.BIND_FAILED.getCommandStatus());
	...
	public void shouldFailSecondBind() throws Exception {
        ...
        Assert.assertEquals(packet.getCommandStatus(), ResponseStatus.OK.getCommandStatus());
        ...
        Assert.assertNotNull(packet);
        Assert.assertEquals(packet.getCommandId(), SMPPPacket.BIND_TRANSCEIVER_RESP);
        Assert.assertEquals(packet.getCommandStatus(), ResponseStatus.ALREADY_BOUND.getCommandStatus());
	}
	...
	public void shouldFailCommandBeforeBind() throws Exception {
        ...
        Assert.assertEquals(packet.getCommandStatus(), ResponseStatus.INVALID_BIND_STATUS.getCommandStatus());
