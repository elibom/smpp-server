...
A project based on the "smppapi":http://smppapi.sourceforge.net/ library that accepts client connections and allows you to process SMPP packets.
...
If you don't provide a @PacketProcessor@ implementation, the default always returns @ResponseStatus.OK@.
