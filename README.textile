...
Finally, you will need to pass your @PacketProcessor@ implementation to the @SmppServer@ using the constructor or the setter method:
...
That's it! As you can see, it's a simple, yet powerful design.