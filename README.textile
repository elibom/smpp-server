The SMPP Server accepts client connections and allows you to process SMPP packets. The project is based on the "smppapi":http://smppapi.sourceforge.net/ library.

To start the accepting connections you need to instantiate the @org.gescobar.SmppServer@ class and call the @start()@ method:
...
To process SMPP packets, you will need to provide an implementation of the @org.gescobar.PacketProcessor@:
